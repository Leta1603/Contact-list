    ...
    editIconsArray.forEach((icon, index)=>{
        icon.addEventListener("click", (e)=>{
            ...
            if (Number(contactItem.dataset.contactid) === index) {
                ...
                (0, _sidebar.openSideBar)(contactSidebar);
...
groupsBtn?.addEventListener("click", (e)=>{
    e.preventDefault();
    (0, _sidebar.openSideBar)(groupsSidebar);
});
...
groupsSidebarCloseBtn?.addEventListener("click", ()=>{
    (0, _sidebar.closeSideBar)(groupsSidebar);
});
contactSidebarCloseBtn?.addEventListener("click", ()=>{
    (0, _sidebar.closeSideBar)(contactSidebar);
});
addGroupBtn.addEventListener("click", (e)=>{
    e.preventDefault();
    const groupList = document.querySelector(".group-list");
    const lastInput = groupList.querySelector(".group-list__item:last-child input");
    ...
    if (!lastInput || lastInput && lastInput.value.trim() !== "") {
        if (lastInput && !groups.includes(lastInput.value.trim())) {
            ...
            (0, _group.createGroupList)(groups);
        ...
        showTitlesOfGroups();
    } else alert("\u041F\u043E\u0436\u0430\u043B\u0443\u0439\u0441\u0442\u0430, \u0432\u0432\u0435\u0434\u0438\u0442\u0435 \u043D\u0430\u0437\u0432\u0430\u043D\u0438\u0435 \u0432 \u043F\u043E\u0441\u043B\u0435\u0434\u043D\u0438\u0439 \u0438\u043D\u043F\u0443\u0442 \u043F\u0435\u0440\u0435\u0434 \u0434\u043E\u0431\u0430\u0432\u043B\u0435\u043D\u0438\u0435\u043C \u043D\u043E\u0432\u043E\u0433\u043E.");
});
function saveGroup() {
    const groupList = document.querySelector(".group-list");
...
},{"./render":"6Nkx6","./localStorage":"45bAM","./sidebar":"dtJiX","./group":"79UjK"}],"6Nkx6":[function(require,module,exports) {
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"dtJiX":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "openSideBar", ()=>openSideBar);
parcelHelpers.export(exports, "closeSideBar", ()=>closeSideBar);
var _localStorage = require("./localStorage");
var _group = require("./group");
const groupsSidebar = document.querySelector(".sidebar-groups");
const contactSidebar = document.querySelector(".sidebar-contact");
...
function openSideBar(sidebar) {
    ...
    if (sidebar === groupsSidebar) {
        ...
        (0, _group.createGroupSelect)(groups);
    }
...
},{"./localStorage":"45bAM","./group":"79UjK","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"79UjK":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "deleteGroup", ()=>deleteGroup);
parcelHelpers.export(exports, "createGroupList", ()=>createGroupList);
parcelHelpers.export(exports, "createGroupSelect", ()=>createGroupSelect);
var _localStorage = require("./localStorage");
var _render = require("./render");
const groupSelect = document.getElementById("groups");
...
},{"./localStorage":"45bAM","./render":"6Nkx6","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["aP7aF","8lRBv"], "8lRBv", "parcelRequiref350")
